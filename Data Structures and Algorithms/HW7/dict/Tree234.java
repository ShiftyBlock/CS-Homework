...
public class Tree234 extends IntDictionary {
    ...
    public void insert(int key) {
        if(!find(key)) {
            ...
            if(root.keys==3) {
                Tree234Node temp= new Tree234Node(null,root.key2);
                sibnode= new Tree234Node(temp,root.key3);
            ...
            node=root;
            Tree234Node par=null;
            while(node!=null) {
                // node other than root
                if(node.keys==3) {
                    par = node.parent;
                    sibnode = new Tree234Node(par,node.key3);
                    // sibnode first
