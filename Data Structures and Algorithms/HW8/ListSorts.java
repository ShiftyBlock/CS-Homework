    ...
    public static LinkedQueue mergeSortedQueues(LinkedQueue q1, LinkedQueue q2) {
        ...
        try {
            while((!q1.isEmpty()) && (!q2.isEmpty())) {
                ...
                if(e1.compareTo(e2) <= 0) q.enqueue(q1.dequeue());
 else  q.enqueue(q2.dequeue());
            }
            if(q1.isEmpty())  q.append(q2);
            
            if(q2.isEmpty())  q.append(q1); 
        } 
        catch (QueueEmptyException e) {
            System.err.println(e+" at "+getLineNumber());
        }
    ...
    public static void partition(LinkedQueue qIn, Comparable pivot, 
        ...
        try {
            ...
            while(!qIn.isEmpty()) {
                ...
                if(comVal<0) qLarge.enqueue(tmp);
                else if(comVal== 0) qEquals.enqueue(tmp);
                else qSmall.enqueue(tmp);
            }
        } catch (QueueEmptyException e) {
            System.err.println(e+" at "+getLineNumber());
        }
