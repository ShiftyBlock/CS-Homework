...
class Date {
  ...
  public Date(int month, int day, int year) {
      if(month==null || day==null || year==null || !isValidDate(month,day,year)){
  ...
  public Date(String s) {
    this(Integer.valueOf(s.split("/")[0]),Integer.valueOf(s.split("/")[1]),Integer.valueOf(s.split("/")[2]) );
  }
  ...
  public static int daysInMonth(int month, int year) {
    ...
    else if(month<8 && month%2==1) days=31;            
    else if(month<8 && month%2==0) days=30;
    else if(month>=8 && month%2==1) days=30;
    else if(month>=8 && month%2==0) days=31;
    return days;
  }
  ...
  public boolean isBefore(Date d) {
    ...
    else if(d.year>this.year) return true;
  ...
  public int dayInYear() {
    int sum=0;
    for(int mo=1; mo<this.month; mo++){
        sum+=daysInMonth(mo, this.year);
    }                      
    sum+=this.day;
    return sum;
  }
  ...
  public int difference(Date d) {
    ...
    while(low<high){
      yearsum+=365;
      if(isLeapYear(low)) yearsum++;
      low++;
    }
    return this.dayInYear()-d.dayInYear()+multiply*yearsum;
